...
}
{
    ...
    else
    {
        ...
        printf("\t\t\t\t<w><n>%s</n><a>%s</a><p>%s</p><l>%s</l><s>%s</s></w>\n", word, accented_word, lex_word, lex_accented_word, strong_lookup( lex_accented_word, lex_word ) );
    }
}
END{     print "</ver></ch></book></lxx>";  }
