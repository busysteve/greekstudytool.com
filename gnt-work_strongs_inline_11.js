...
function showparse( px, pcode )
{
	...
	else
	{
		...
		{
		case "n":
			out += "Nominative - <span style='font-size:12px;'>The nominative case is the noun the sentence is about.  The one doing the verb.  It is like the subject in English.</span>";
			break;
		case "v":
			out += "Vocative - <span style='font-size:12px;'>The noun being addressed or spoken to.</span>";
			break;
		case "g":
			out += "Genitive - <span style='font-size:12px;'>The noun that has or owns the noun in the nominative case.</span>";
			break;
		case "d":
			out += "Dative - <span style='font-size:12px;'>The noun a verb is acting for, towards or against.</span>";
			break;
		case "a":
			//out += "Accusative";
			out += "Accusative - <span style='font-size:12px;'>The word in the accusitive case is the noun that is being effected by the noun in the nominative case.</span>";
			break;
		}
